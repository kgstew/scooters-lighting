...
struct OnOffLed : Service::LightBulb {               // ON/OFF LED

  int ledPin;                                       // pin number defined for this LED
  SpanCharacteristic *power;                        // reference to the On Characteristic
  
  OnOffLed(int ledPin) : Service::LightBulb(){       // constructor() method
...
struct DimmableLED : Service::LightBulb {       // Dimmable LED
  ...
  DimmableLED(int pin) : Service::LightBulb(){       // constructor() method
